...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		hwStatic_word = CreateWindow("STATIC", "Введите gamma:", WS_CHILD | WS_VISIBLE, 15, 15, 120, 32, hWnd, NULL, NULL, NULL);
		...
		hwEdit_step = CreateWindow("EDIT", "key", WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 15, 40, 50, 20, hWnd, NULL, NULL, NULL);
